(()=>{
  ...
  function ensureStyles(){
    ...
    style.id=STYLE_ID;
    style.textContent=`
      .mr-partner-logo{display:flex;align-items:center;justify-content:center;width:min(100%,420px);min-height:160px;margin:16px 0 22px;padding:10px;border:2px solid #d0a93a;border-radius:16px;background:#fff;overflow:hidden}
      .mr-partner-logo img{display:block;max-width:100%;width:auto;height:auto;max-height:390px;object-fit:contain}
      .mr-partner-logo-fallback{display:none;align-items:center;justify-content:center;width:100%;min-height:140px;padding:24px;text-align:center;font-weight:950;font-size:clamp(22px,5vw,38px);line-height:1.05;color:#0a315e;background:linear-gradient(145deg,#fff,#eef4f7)}
      .mr-partner-logo.is-fallback img{display:none}
      .mr-partner-logo.is-fallback .mr-partner-logo-fallback{display:flex}
      @media(max-width:680px){.mr-partner-logo{width:100%;min-height:120px;margin:14px 0 18px;padding:8px}.mr-partner-logo img{max-height:310px}.mr-partner-logo-fallback{min-height:110px}}
    `;
