...
for (const file of ['school.html','installation.html','detail-links.js','deal-expiry.js','weekly.js','home-priority.js','labor-day.html','local-intel.html','local-intel-embeds.js','instagram-connect.js','deal-share.js','99012cfad8c2e9d0d3cc9683bb7afaba.txt']) await copyFile(file, `dist/${file}`);
...
console.log('Mission Rated homepage priorities, Labor Day, Local Intel, Instagram connection, deal sharing, IndexNow key and AI discovery metadata added to release');
