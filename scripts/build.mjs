...
const htmlFiles = ['index.html', 'military-value.html', 'schools.html', 'bases.html', 'neighborhoods.html', 'community.html'];
...
for (const file of htmlFiles) {
  ...
  if (!html.includes('rankings.js') && !['neighborhoods.html','community.html'].includes(file)) html = html.replace('</body>', '<script src="/rankings.js" defer></script>\n</body>');
  if (!html.includes('quick-vote.js') && !['neighborhoods.html','community.html'].includes(file)) html = html.replace('</body>', '<script src="/quick-vote.js" defer></script>\n</body>');
  if (!html.includes('reviews.js') && file !== 'community.html') html = html.replace('</body>', '<script src="/reviews.js" defer></script>\n</body>');
