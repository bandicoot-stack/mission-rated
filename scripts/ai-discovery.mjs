...
const descriptions={
  ...
  'fall.html':'Fall Deals & Finds for Hampton Roads military families: source-backed pumpkin patches, farms, hayrides, corn mazes, festivals and seasonal activities.',
...
const titles={
  ...
  'fall.html':'Fall Deals & Finds in Hampton Roads | Mission Rated',
