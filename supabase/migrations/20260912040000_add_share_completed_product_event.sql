-- Align the durable product_events constraint with the currently supported
-- Growth ingest contract. Preserve existing non-Growth/legacy event names;
-- this migration only fixes the verified share_completed rejection.
