...
- [x] Add the exact active v2 `index.ts` source under `supabase/functions/public-neighborhoods/`.
- [x] Run Mission Rated QA and Mission Rated Integration QA on the exact PR head.
- [x] Stop at a green reviewable PR; do not merge or deploy from the overnight run.
